...
public class ConditionalShapedRecipeBuilder
{
	...
	private ConditionalShapedRecipeBuilder(RecipeSerializer<?> serializerIn, ItemLike resultIn, int countIn) 
	{
	...
	{
		return new ConditionalShapedRecipeBuilder(RecipeSerializer.SHAPED_RECIPE, itemIn, 1);
	}
	
	public static ConditionalShapedRecipeBuilder shaped(ItemLike itemIn, int countIn)
	{
		return new ConditionalShapedRecipeBuilder(RecipeSerializer.SHAPED_RECIPE, itemIn, countIn);
	}
	
	public static ConditionalShapedRecipeBuilder shapedCustom(RecipeSerializer<?> serializerIn, ItemLike itemIn)
	{
		return new ConditionalShapedRecipeBuilder(serializerIn, itemIn, 1);
	}
	...
	public void save(Consumer<FinishedRecipe> consumerIn, ResourceLocation id)
	{
		...
		consumerIn.accept(new Result(serializer, id, result, count, group == null ? "" : group, pattern, keys, conditions, advancementBuilder, new ResourceLocation(id.getNamespace(), "recipes/" + result.getItemCategory().getRecipeFolderName() + "/" + id.getPath())));
	}
	...
	public class Result implements FinishedRecipe
	{
		...
		public Result(RecipeSerializer<?> serializerIn, ResourceLocation idIn, Item resultIn, int countIn, String groupIn, List<String> patternIn,
